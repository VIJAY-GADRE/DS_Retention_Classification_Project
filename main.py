...
def index_page():
    """
    * method: index_page
    * description: To invoke index html page
    * return: None
    *
...
def training_route_client():
    ...
    *   None
    ...
    try:
        ...
        return Response("Training Successful!!! and its Run_ID is: " + str(run_id))
    except ValueError:
...
def batch_prediction_route_client():
    ...
    * description: To invoke batch prediction route
    * return: None
    *
    * who             when           version  change (include bug# if apply)
    * ----------      -----------    -------  ------------------------------
    ...
    *   None
    ...
    try:
        ...
        return Response('Prediction Successful!!! and its Run_ID is: ' + str(run_id))
    except ValueError:
        return Response("Error Occurred! %s " % ValueError)
    except KeyError:
        return Response("Error Occurred! %s " % KeyError)
